    ...
    <section id="NewBookSlide"  style="margin-bottom : 70px;">
        ...
        <article class="new-book-slide">
        	...
        	<c:forEach var="newBook" items="${newBook }" begin="7" end="26">
        		<div style="width : 180px"  onclick="link('${newBook.link}')">
        			<div class="imgbg" style="background: url('${newBook.coverLargeUrl }') center no-repeat;  background-size: contain;"></div>
        ...
        <div class="recommend" style="width : 90%; margin : 0 auto;">
					<div class="book-grid" style="display : grid; grid : repeat(1, 100%)/auto-flow 23%;grid-column-gap: 28px;">
							<c:forEach var="book" items="${recommend }" begin="0" end="3">
								<div style=" width : 220px; height : 300px; margin : 0 auto; "  onclick="link('${book.link}')">
    ...
    <h1 onclick="location.href='${cpath}/books/bestSeller'" title="베스트셀러 더보기" style="cursor: pointer;">베스트셀러</h1>
    	<div class="week">
    		...
    		<c:forEach var="best" items="${best }" begin="0" end="8">
    			<li class="clearfix"  onclick="link('${best.link}')">
     ...
     <section id="week-bestWrap">
       ...
       <div class="week">
    		...
    		<c:forEach var="history" items="${history }" begin="0" end="8">
    			<li class="clearfix" onclick="link('${history.link}')">
